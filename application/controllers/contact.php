...
class contact extends CI_Controller {
	// settings
	protected 	$sendEmailTo 		= 	'contact@dkcommunication.fr'; //change this!
	protected	$subjectLine 		= 	""; // actually set on line 58.
	
	// views
	protected 	$formView			= 	'contact/contact';
	protected	$successView		= 	'contact/success';
	protected	$errorView			= 	'contact/error'; //used when the mail failed.
	...
	protected function set_validation_rules() {
		...
		$this->form_validation->set_rules('Object', 'Objet', 'trim|required');
